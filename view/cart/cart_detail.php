                    ...
                    <table class="table table-responsive">
                        ...
                        <?php foreach ($_SESSION["cart"] as $key => $value){ ?>
                            <form method="post" action="?controller=Cart&action=addCart">
                                <tr>
                                    <td>
                                        <img width="80" height="100" src="public/images/book/<?php echo $value['image']; ?>" alt="image description">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" name="num-product1" value="<?php echo $value['quantity']; ?>">

                                        <button><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    </td>
                                    <td><?php echo number_format($value['price']*$value["quantity"]); ?> VND</td>
                                    <td>
                                        ...
                                        <button class="tg-btn tg-active" href="javascript:void(0);">Update Cart</button>
                                    </td>
                                </tr>
                            </form>
                        <?php } ?>
                    ...
                    <form class="tg-formtheme tg-formcontactus">
                        <fieldset>
                            <div class="form-group">
                                <input type="text" name="coupon-code" class="form-control" placeholder="Coupon Code">
                            </div>
                            <div class="form-group">
                                <div class="tg-btns">
                                    <a class="tg-btn tg-active" href="javascript:void(0);">Apply coupon</a>
                                    <a class="tg-btn tg-active pull-right" href="?controller=Cart&action=deleteCart">Delete All Products</a>
                                </div>
                            </div>
                        </fieldset>
                    </form>
