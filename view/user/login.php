<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
    ...
    *************************************-->
    <section class="tg-sectionspace tg-haslayout">
        <div class="container">
            <div class="row">
                <form class="m-3" method="post" action="?controller=User&action=sLogin">
                    Username: <input class="border form-control" type="text" name="username" id="username" placeholder="Nhập username"><span><br /><br />
                    Password: <input class="border form-control" type="password" name="password" id="password" placeholder="Nhập password"><br />
                    <input class="btn btn-primary" type="submit" value="Đăng nhập" id="btn" name="submit"> <br>
                </form>
            </div>
        </div>
    </section>
