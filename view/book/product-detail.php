                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9 pull-right">
                            <div id="tg-content" class="tg-content">
                                    ...
                                    <div class="tg-featureditm">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 hidden-sm hidden-xs">
                                                <figure><img src="public/images/img-04.png" alt="image description"></figure>
                                            </div>
                                ...
                                <div class="tg-productdetail">
                                    <div class="row">
                                        <form method="post" action="?controller=Cart&action=addCart">
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                <div class="tg-postbook">
                                                    <figure class="tg-featureimg"><img src="public/images/book/<?php echo $result["img"]; ?>" alt="image description"></figure>
                                                    <div class="tg-postbookcontent">
                                                        <span class="tg-bookprice">
                                                                <ins><?php echo $result["price"]; ?> VND</ins>
                                                                <del>$27.20</del>
                                                            </span>
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo $result['book_id']; ?>">
                                                        <input type="hidden" name="title" value="<?php echo $result['book_name']; ?>">
                                                        <input type="hidden" name="price" value="<?php echo $result['price']; ?>">
                                                        <input type="hidden" name="image" value="<?php echo $result['img']; ?>">
                                                        <button class="tg-btn tg-active tg-btn-lg" href="javascript:void(0);">Add To Basket</button>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                            <div class="tg-productcontent">
                                                ...
                                                <ul class="tg-productinfo">
                                                    ...
                                                    <li><span>Illustrations note:</span><span>b&amp;w public/images thru-out; 1 x 16pp colour plates</span></li>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="tg-authorbox">
                                                    <figure class="tg-authorimg">
                                                        <img src="public/images/author/imag-24.jpg" alt="image description">
                                                    </figure>
                                                ...
                                                <div id="tg-relatedproductslider" class="tg-relatedproductslider tg-relatedbooks owl-carousel">
                                                        ...
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-01.jpg" alt="image description"></div>
                                                    ...
                                                    <div class="item">
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-02.jpg" alt="image description"></div>
                                                                    <div class="tg-backcover"><img src="public/images/books/img-02.jpg" alt="image description"></div>
                                                                </div>
                                                                <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                                    <i class="icon-heart"></i>
                                                                    <span>add to wishlist</span>
                                                    ...
                                                    <div class="item">
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-03.jpg" alt="image description"></div>
                                                                    <div class="tg-backcover"><img src="public/images/books/img-03.jpg" alt="image description"></div>
                                                                </div>
                                                                <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                                    <i class="icon-heart"></i>
                                                                    <span>add to wishlist</span>
                                                    ...
                                                    <div class="item">
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-04.jpg" alt="image description"></div>
                                                                    <div class="tg-backcover"><img src="public/images/books/img-04.jpg" alt="image description"></div>
                                                                </div>
                                                                <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                                    <i class="icon-heart"></i>
                                                                    <span>add to wishlist</span>
                                                    ...
                                                    <div class="item">
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-05.jpg" alt="image description"></div>
                                                                    <div class="tg-backcover"><img src="public/images/books/img-05.jpg" alt="image description"></div>
                                                                </div>
                                                                <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                                    <i class="icon-heart"></i>
                                                                    <span>add to wishlist</span>
                                                    ...
                                                    <div class="item">
                                                        <div class="tg-postbook">
                                                            <figure class="tg-featureimg">
                                                                <div class="tg-bookimg">
                                                                    <div class="tg-frontcover"><img src="public/images/books/img-06.jpg" alt="image description"></div>
                                                                    <div class="tg-backcover"><img src="public/images/books/img-06.jpg" alt="image description"></div>
                                                                </div>
                                                                <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                                    <i class="icon-heart"></i>
                                                                    <span>add to wishlist</span>
